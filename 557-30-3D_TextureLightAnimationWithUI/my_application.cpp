...
void MyApplication::run() 
{
    ...
    while (!m_myWindow.shouldClose()) 
    {
        ...
        if (auto commandBuffer = m_myRenderer.beginFrame())
		{
            ...
            ubo.pointLight.position.x += (m_myGUIData.fMoveValues[0] - 0.5f) * 4.0f;
            ubo.pointLight.position.y += (m_myGUIData.fMoveValues[1] - 0.5f) * 4.0f;
            ubo.pointLight.position.z += (m_myGUIData.fMoveValues[2] - 0.5f) * 4.0f;
