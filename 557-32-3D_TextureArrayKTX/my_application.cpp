...
const std::string TEXTURE_PATH = "./textures/texturearray_rgba.ktx";

MyApplication::MyApplication() :
    m_bPerspectiveProjection(true),
    m_iTextureID(0),
    m_iNumTexureLayers(0)
{
    m_pMyGlobalPool =
...
void MyApplication::run() 
{
    ...
    m_iNumTexureLayers = myTexture.numTextureLayers();
...
{
    m_iTextureID++;
    if (m_iTextureID > m_iNumTexureLayers-1) m_iTextureID = 0;
}
