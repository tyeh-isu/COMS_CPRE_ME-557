...
void MyCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up)
{
    ...
    m_m4InverseViewMatrix[0][0] = u.x;
    m_m4InverseViewMatrix[1][0] = u.y;
    m_m4InverseViewMatrix[2][0] = u.z;
    m_m4InverseViewMatrix[0][1] = v.x;
    m_m4InverseViewMatrix[1][1] = v.y;
    m_m4InverseViewMatrix[2][1] = v.z;
    m_m4InverseViewMatrix[0][2] = w.x;
    m_m4InverseViewMatrix[1][2] = w.y;
    m_m4InverseViewMatrix[2][2] = w.z;
...
void MyCamera::setViewYXZ(glm::vec3 position, glm::vec3 rotation)
{
    ...
    m_m4InverseViewMatrix = glm::mat4{ 1.f };
    m_m4InverseViewMatrix[0][0] = u.x;
    m_m4InverseViewMatrix[0][1] = u.y;
    m_m4InverseViewMatrix[0][2] = u.z;
    m_m4InverseViewMatrix[1][0] = v.x;
    m_m4InverseViewMatrix[1][1] = v.y;
    m_m4InverseViewMatrix[1][2] = v.z;
    m_m4InverseViewMatrix[2][0] = w.x;
    m_m4InverseViewMatrix[2][1] = w.y;
    m_m4InverseViewMatrix[2][2] = w.z;
    m_m4InverseViewMatrix[3][0] = position.x;
    m_m4InverseViewMatrix[3][1] = position.y;
    m_m4InverseViewMatrix[3][2] = position.z;
