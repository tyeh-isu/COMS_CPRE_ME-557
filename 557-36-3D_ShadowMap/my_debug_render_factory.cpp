...
MyDebugRenderFactory::MyDebugRenderFactory(MyDevice& device, VkRenderPass renderPass, VkDescriptorSetLayout globalSetLayout)
    : m_myDevice{ device } 
{
...
MyDebugRenderFactory::~MyDebugRenderFactory()
{
    vkDestroyPipelineLayout(m_myDevice.device(), m_vkPipelineLayout, nullptr);
}

void MyDebugRenderFactory::_createPipelineLayout(VkDescriptorSetLayout globalSetLayout)
{
...
void MyDebugRenderFactory::_createPipeline(VkRenderPass renderPass)
{
    ...
    m_pMyPipeline = std::make_unique<MyPipeline>(
        m_myDevice,
        "shaders/debug_shader.vert.spv",
        "shaders/debug_shader.frag.spv",
        pipelineConfig);
}

void MyDebugRenderFactory::renderGameObjects(MyFrameInfo& frameInfo)
{
    ...
    {
	    auto& obj = kv.second;
        if (obj.type() == MyGameObject::DEBUG) // draw floor only
        {
