...
public:
    ...
    VkRenderPass    offscreenRenderPass() const { return m_mySwapChain->shadowMapRenderPass(); }
    ...
    // Shadow map
    VkDescriptorImageInfo shadowMapDescriptorInfo() { return m_mySwapChain->shadowMapDescriptorInfo(); }
