...
void MyPointLightRenderSystem::update(MyGlobalUBO& ubo, const glm::vec3 offset)
{
    // Update light position to UBO
    ubo.pointLight.position += glm::vec4(offset, 1.0f);
}

void MyPointLightRenderSystem::render(MyFrameInfo& frameInfo) 
{
