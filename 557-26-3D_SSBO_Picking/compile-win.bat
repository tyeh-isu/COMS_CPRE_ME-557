...
%VULKAN_SDK%/bin/glslc.exe ./shaders/pick_shader.vert -o ./shaders/pick_shader.vert.spv
%VULKAN_SDK%/bin/glslc.exe ./shaders/pick_shader.frag -o ./shaders/pick_shader.frag.spv